    ...
    if (itemType === "SERVICE") {
        ...
        if (hasSub === hasSup) {
            ctx.addIssue({
                code: "custom",
                path: ["relatedSubcontractorId"],
                message: "Servis için taşeron işi veya tedarik bilgisinden tam olarak biri verilmelidir.",
            });
        }
