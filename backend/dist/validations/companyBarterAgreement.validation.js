...
exports.barterUpdateSchema = exports.barterCreateSchema = void 0;
const zod_1 = require("zod");
const enums_1 = require("./enums");
exports.barterCreateSchema = zod_1.z
    .object({
    projectId: zod_1.z
        .string({ required_error: "Proje zorunludur." })
        .uuid("Geçerli bir proje ID giriniz."),
    counterpartyType: enums_1.CounterpartyType, // servis zaten upper-case bekliyor
    counterpartyId: zod_1.z
        .string()
        .uuid("Geçerli bir karşı taraf giriniz.")
        .optional(),
    counterpartyName: zod_1.z
    ...
    agreementDate: zod_1.z.any(),
    status: enums_1.BarterStatus.default("ACTIVE"),
    description: zod_1.z.string().trim().optional(),
    totalOurValue: zod_1.z.coerce
        .number({ invalid_type_error: "Bizim değerimiz sayısal olmalıdır." })
        .min(0, "Bizim değerimiz negatif olamaz.")
        .optional()
        .default(0),
    totalTheirValue: zod_1.z.coerce
...
exports.barterUpdateSchema = zod_1.z
    .object({
    projectId: zod_1.z.string().uuid("Geçerli bir proje giriniz.").optional(),
    counterpartyType: enums_1.CounterpartyType.optional(),
    counterpartyId: zod_1.z
        .string()
    ...
    /*agreementDate: z.coerce
      .date({ invalid_type_error: "Geçerli bir anlaşma tarihi giriniz." })
      .optional(),*/
    agreementDate: zod_1.z.any().optional(),
    status: enums_1.BarterStatus.optional(),
    description: zod_1.z.string().trim().optional(),
    totalOurValue: zod_1.z.coerce
        .number({ invalid_type_error: "Bizim değerimiz sayısal olmalıdır." })
        .min(0, "Bizim değerimiz negatif olamaz.")
    ...
    .refine((body) => Object.keys(body).length > 0, // en az bir alan güncellenmeli
