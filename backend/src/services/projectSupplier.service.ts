...
export const createProjectSupplier = async (
  ...
  // ✅ Quantity Item'ı bul (şirket filtresiyle)
...
export const updateProjectSupplier = async (
  ...
  const supplierRepo = manager.getRepository(ProjectSupplier);
  const estimatedCostRepo = manager.getRepository(ProjectEstimatedCost); // ✅ EstimatedCost ekledik
  ...
  const supplier = await supplierRepo.findOne({
    ...
    relations: ["project", "company", "quantityItem", "projectQuantity"], // ✅ Ek ilişkiler AGREED için gerekli
  });
  ...
  // ✅ Kalan tutar yeniden hesaplanıyor
  if (
